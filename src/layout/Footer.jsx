        ...
        >
            ...
            <div className="w-full mb-16 overflow-y-hidden no-scrollbar">
                <Marquee speed={350} gradient={false} pauseOnHover={true}>
                    <span className="text-[70px] md:text-9xl text-dark font-[200] mr-16">{marqueeText}</span>
                    <span className="text-[70px] md:text-9xl text-dark font-[200] mr-16">{marqueeText}</span>
                </Marquee>
            </div>
            ...
            <div className="relative md:flex md:flex-col md:justify-center items-center z-10 max-w-2xl mx-auto text-center mb-16">
                <img src={paperPlaneIcon} alt="Subscribe" className="mx-auto mb-5 bg-dark-brown p-2 rounded w-10 h-10" />
                ...
                <form className="relative max-w-lg mx-auto mb-4">
                    ...
                    >
                        <img src={sendIcon} alt="Subscribe" className="w-4 h-4 mr-2 opacity-70" />
                        Subscribe
                    </button>
                </form>
                ...
                <div className="flex items-center justify-center text-xs text-gray-500">
                    ...
                    <label htmlFor="privacy">
                        I agree to the <a href="/privacy-policy" className="underline hover:text-black">Privacy Policy</a>
                    </label>
                </div>
            </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto pt-8 border-t-2 border-dark">
                <div className="flex flex-col md:flex-row justify-between items-center text-center gap-6">
                    ...
                    <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-gray-700">
                        ...
                        <a href="/offers" className="hover:underline">Offers & Packages</a>
                    ...
                    <div className="flex items-center gap-2">
                        <a href="#" className="w-8 h-8 flex items-center justify-center bg-white rounded-md border border-gray-200"><img src={facebookIcon} alt="Facebook" className="w-4 h-4" /></a>
                        <a href="#" className="w-8 h-8 flex items-center justify-center bg-white rounded-md border border-gray-200"><img src={twitterIcon} alt="Twitter" className="w-4 h-4" /></a>
                        <a href="#" className="w-8 h-8 flex items-center justify-center bg-white rounded-md border border-gray-200"><img src={instagramIcon} alt="Instagram" className="w-4 h-4" /></a>
                        <a href="#" className="w-8 h-8 flex items-center justify-center bg-white rounded-md border border-gray-200"><img src={linkedInIcon} alt="LinkedIn" className="w-4 h-4" /></a>
                    </div>
                </div>
            </div>
        </footer>
