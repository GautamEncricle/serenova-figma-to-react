          ...
          <div className="lg:w-10/12 lg:flex-shrink-0">
            <div className="text-center lg:text-left lg:w-8/12">
              ...
              <h1 className="mt-6 text-3xl md:text-4xl lg:text-[1.9rem] font-extralight text-gray-500 leading-tight lg:w-auto md:w-full">
                A Place Where{" "}
                <strong className="font-semibold text-stone-800">Luxury</strong>{" "}
                Comes Gently And Every Stay Feels Like Coming Home Crafted For
                The{" "}
                <strong className="font-semibold text-stone-800">Soul.</strong>
              </h1>
            </div>
            ...
            >
              ...
              <div className="w-full lg:flex-grow lg:pl-12">
                <p className="font-sans text-base text-stone-600 leading-relaxed text-center lg:text-left">
                  Tucked along the quiet coast, Serenova is more than a
                  destination—it’s a philosophy of peace, space, and soulful
                  hospitality. Every corner of our resort is shaped by the
                  rhythm of nature and the comforts of curated design. Whether
                  you’re watching the sunrise from your private deck or dining
                  under the stars, Serenova offers something rare: the freedom
                  to truly unwind. We are more than a resort; Serenova is a
                  mood, a moment, a memory in the making. And once you’ve
                  experienced it, you’ll carry its calm with you long after
