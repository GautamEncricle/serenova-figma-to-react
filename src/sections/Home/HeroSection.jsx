            ...
            <div className="w-full max-w-7xl mx-auto">
                ...
                <div className="hidden lg:block relative">
                    ...
                    <div className="absolute font-teacher inset-0 z-10 flex flex-col md:-top-40 items-center justify-center text-center text-black pointer-events-none">
                        ...
                        <h1 className="text-7xl font-thin tracking-wide leading-tight">Let the Ocean</h1>
                    ...
                    <div className="grid grid-cols-3 grid-rows-2 gap-2 auto-rows-[250px]">
                        ...
                        <div className="rounded-lg overflow-hidden">
                            <div className='relative h-[350px]  '>
                                <img src={bedroomImg} alt="Person on paddleboard" className="absolute md:w-[350px] md:right-5 md:h-[230px] w-full h-full object-cover" />
                                <img src={paddleboardImg} alt="Person on paddleboard" className="absolute md:w-[140px] left-[0] top-40 md:h-[150px] w-full h-full object-cover" />
                            </div>
                        </div>
                        <div className="rounded-lg overflow-hidden">
                        </div>
                        <div className="rounded-lg overflow-hidden">
                            <img src={poolWomanImg} alt="Woman by the pool" className="w-full h-full md:w-full md:h-[250px] object-cover" />
                        </div>

                        {/* Row 2 */}
                        <div className="rounded-lg overflow-hidden">
                            <img src={boardwalkImg} alt="Boardwalk at sunset" className="w-full h-full md:w-[100%] md:h-[280px] object-cover mb-0" />
                        </div>
                        <div className="rounded-lg overflow-hidden">
                        </div>
                        <div className="rounded-lg overflow-hidden">
                            <div className='relative h-[350px] left-0'>
                                <img src={beachChairsImg} alt="beach chairs" className="absolute md:w-[130px] right-10 -top-0 md:h-[150px] w-full h-full object-cover" />
                                <img src={aerialIslandsImg} alt="Aerial view of islands" className="absolute md:w-[300px] md:left-5 md:bottom-20 md:h-[180px] w-full h-full object-cover" />
                            </div>
                        </div>
                    </div>
